    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitulo}>
          Nota: Haz doble click para Aceptar o Rechazar!!!
        </Text>
        <TextInput
          style={styles.input}
        ...
        />
        {claveInvalida && (
          <Text style={styles.claveInvalida}>Clave de empleado inválida</Text>
        )}
      </View>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <SolicitudCard
            solicitud={item}
            onUpdateEstado={updateEstadoSolicitud}
          />
        )}
      />
    </SafeAreaView>
  ...
  return (
    <View style={styles.card}>
      <Text style={styles.titulo}>
        Número de empleado: {solicitud.clave_empleado}
      </Text>
